    ...
    app.put('/coffee/:id', async (req, res) => {
      ...
      const coffee = {
        $set: {
          ...
          // quantity, taste, detail, photoURL, category
      ...
      const result = await coffeeCollection.updateOne(filter, coffee, optins)
      res.send(result)
    })
...
app.get('/', (req, res) => {
  res.send('coffee making')
})

app.listen(port, () => {
  console.log(`the coffee is running ${port}`);
})